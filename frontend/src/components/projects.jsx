...
// Import all project images with exact filenames
    ...
    `}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className={`
            max-w-2xl mx-auto text-base mb-8
          ...
          <div className="flex flex-wrap justify-center gap-6 md:gap-12">
            {[
              ...
              <div key={i} className="text-center">
                ...
                <p className={`text-xs md:text-sm mt-1 ${isDarkMode ? 'text-slate-500' : 'text-slate-400'}`}>
                  {stat.label}
                </p>
              </div>
            ))}
            ...
            >
              ...
              <div className="relative overflow-hidden aspect-[16/10]">
                {project.images.length > 1 ? (
                  <div className="grid grid-cols-2 h-full gap-0.5 bg-slate-200 dark:bg-slate-800">
                ...
                <div className="absolute top-4 right-4 z-10">
                  <span className={`
                    px-3 py-1 rounded-full text-xs font-bold backdrop-blur-md
                    ${isDarkMode ? 'bg-slate-900/90 text-slate-300 border border-slate-700' : 'bg-white/90 text-slate-700 border border-slate-200'}
                  `}>
                    {project.year}
                  </span>
                </div>
              ...
              <div className="p-6">
                ...
                <div className="space-y-2 mb-5">
                  {project.features.slice(0, 4).map((feature, idx) => (
                    <div key={idx} className="flex items-center gap-2">
                      <svg className={`w-4 h-4 flex-shrink-0 ${isDarkMode ? 'text-green-400' : 'text-green-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className={`flex items-center justify-between pt-4 border-t ${
                  ...
                  <a href={project.liveUrl} className={`
                    inline-flex items-center gap-1.5 text-sm font-semibold transition-all duration-300 hover:gap-2
        ...
        {/* CTA Section */}
        <div className={`
          mt-16 p-10 md:p-14 rounded-3xl text-center backdrop-blur-xl border
        ...
        `}>
          ...
          <p className={`max-w-xl mx-auto mb-8 ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>
