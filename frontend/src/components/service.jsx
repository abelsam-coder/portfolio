...
const Service = () => {
  ...
  const projects = [
    { id: 1, name: 'E-Commerce Platform', category: 'web', price: '200K+', tech: ['React', 'Node.js', 'PostgreSQL'], icon: Globe, color: '#6366F1', description: 'Full-stack marketplace with payments & analytics' },
    { id: 2, name: 'Chat Application', category: 'web', price: '140K+', tech: ['React', 'Socket.io', 'Redis'], icon: MessageSquare, color: '#8B5CF6', description: 'Real-time messaging with rooms & file sharing' },
    { id: 3, name: 'ERP System', category: 'enterprise', price: '500K+', tech: ['React', 'Node.js', 'PostgreSQL', 'Redis'], icon: Database, color: '#7C3AED', description: 'Enterprise resource planning & automation' },
    { id: 4, name: 'Mobile App', category: 'mobile', price: '200K+', tech: ['React Native', 'Firebase'], icon: Smartphone, color: '#EC4899', description: 'Cross-platform with push notifications' },
    { id: 5, name: 'Security Audit', category: 'security', price: '160K', tech: ['Burp Suite', 'Nmap'], icon: Lock, color: '#F43F5E', description: 'Vulnerability assessment & hardening' },
    { id: 6, name: 'ML Solution', category: 'ml', price: '600K+', tech: ['Python', 'TensorFlow'], icon: Cpu, color: '#14B8A6', description: 'Predictive analytics & model deployment' },
    { id: 7, name: 'API Development', category: 'web', price: '80K+', tech: ['Django', 'REST'], icon: Code, color: '#3B82F6', description: 'Scalable RESTful API architecture' },
    { id: 8, name: 'Telegram Bot', category: 'bot', price: '120K+', tech: ['Node.js', 'Telegraf', 'MongoDB'], icon: Bot, color: '#06B6D4', description: 'Automated bot with payments' },
    { id: 9, name: 'System Dashboard', category: 'management', price: '100K+', tech: ['Docker', 'Grafana', 'Prometheus'], icon: ServerCog, color: '#6366F1', description: 'Real-time monitoring & alerting' }
  ];
  ...
  return (
    ...
    `}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        {/* SERVICES GRID - 3-COL GLASSMORPHISM */}
        ...
        `}>
          ...
          <div className="relative z-10">
            ...
            <div className="relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
              <div className={`hidden lg:block absolute top-8 left-[15%] right-[15%] h-[2px] ${isDark ? 'bg-gradient-to-r from-transparent via-indigo-500/20 to-transparent' : 'bg-gradient-to-r from-transparent via-indigo-200 to-transparent'}`}></div>
